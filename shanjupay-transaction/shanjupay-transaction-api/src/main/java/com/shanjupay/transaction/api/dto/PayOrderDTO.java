...
public class PayOrderDTO implements Serializable {
    ...
    private String appId;// 此处使用业务 id，服务内部使用主键 id，服务与服务之间用业务 id ~ appId。
    ...
    private String openId;// c 端付款用户身份标识。
    private String authCode;// 付款条码，支付宝或者微信点“付款”产生的付款条码。在 b 扫 c 时，应由前端传过来。
    private String device;// 设备。存放 UA 等信息。
    private String clientIp;// 客户端 id。
