...
public class MerchantController {
    ...
    @ApiOperation("根据 id 商户获取商户信息。")
    @ApiImplicitParam(name = "id", value = "商户 id。", required = true, dataType = "Long", paramType = "query")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "merchantId", value = "某个商户 id。", required = true, dataType = "Long", paramType = "query"),
