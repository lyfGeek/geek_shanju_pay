...
public class EncryptUtil {
    ...
    /**
     * 将字符串 str 先使用 utf-8 符集进行 url 编码 + 转为%2B ?转为%3F 等防止传输过程中出问题，然后再进行base64 编码。
     *
     * @param str
     * @return
     */
    ...
    /**
     * 将字符串 str 先进行 base64 解码
     * 然后再使用 utf-8 字符集进行 url 解码。
     *
     * @param str
     * @return
     */
    ...
    public static void main(String[] args) {
        String str = "www.baidu.com?a=1&b=2+1&c=lyfGeek+%&&d=1";
