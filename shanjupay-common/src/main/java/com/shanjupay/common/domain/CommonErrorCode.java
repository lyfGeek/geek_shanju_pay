...
public enum CommonErrorCode implements ErrorCode {
    ...
    E_100105(100105, "ID 格式不正确或超出 Long 存储范围。"),
    ...
    E_999910(999910, "调用微服务 ~ 没有传 tenantId 租户 ID。"),
    E_999911(999911, "调用微服务 ~ 没有 json-token 令牌。"),
    E_999912(999912, "调用微服务 ~ json-token 令牌解析有误。"),
    E_999913(999913, "调用微服务 ~ json-token 令牌有误 ~ 没有当前租户信息。"),
    E_999914(999914, "调用微服务 ~ json-token 令牌有误 ~ 该租户下没有权限信息。"),
