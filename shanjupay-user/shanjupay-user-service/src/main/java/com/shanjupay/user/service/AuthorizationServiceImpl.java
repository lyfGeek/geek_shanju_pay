...
import com.shanjupay.user.convert.IAccountRoleConvert;
import com.shanjupay.user.convert.IAuthorizationPrivilegeConvert;
import com.shanjupay.user.convert.IAuthorizationRoleConvert;
...
public class AuthorizationServiceImpl implements IAuthorizationService {
    ...
    @Autowired
    private IAuthorizationPrivilegeMapper privilegeMapper;
    @Autowired
    ...
    @Autowired
    private IAuthorizationPrivilegeGroupMapper groupMapper;
    ...
    public Map<Long, AuthorizationInfoDTO> authorize(String username, Long[] tenantIds) {
        ...
        Map<Long, AuthorizationInfoDTO> map = new HashMap<>();// key 是租户 id。
        /*{
            租户id:{
                r_001:[p_001,p_002],
                r_002:[p_004,p_005]
    ...
    public List<PrivilegeDTO> queryPrivilege(Long tenantId, String[] roleCodes) {
        ...
        List<PrivilegeDTO> privilegeDTOS = IAuthorizationPrivilegeConvert.INSTANCE.entityList2dto(privileges);
    ...
    public List<PrivilegeDTO> queryPrivilegeByGroupId(Long privilegeGroupId) {
        ...
        List<PrivilegeDTO> privilegeDTOS = IAuthorizationPrivilegeConvert.INSTANCE.entityList2dto(privilegeList);
        return privilegeDTOS;
    }
    ...
    public void createRole(Long tenantId, RoleDTO role) {
        ...
        AuthorizationRole entity = IAuthorizationRoleConvert.INSTANCE.dto2entity(role);
    ...
    public void roleBindPrivilege(Long tenantId, String roleCode, String[] privilegeCodes) {
        ...
        // 将角色和权限进行关联操作 authorization_role_privilege 表。
    ...
    public List<RoleDTO> queryRole(Long tenantId) {
        ...
        List<RoleDTO> roleDTOS = IAuthorizationRoleConvert.INSTANCE.entityList2dto(authorizationRoles);
        return roleDTOS;
    }
    ...
    public RoleDTO queryTenantRole(Long tenantId, String roleCode) {
        ...
        Long id = role.getId();
        RoleDTO roleDTO = IAuthorizationRoleConvert.INSTANCE.entity2dto(role);
    ...
    public List<AccountRoleDTO> queryAccountBindRole(String username, Long tenantId, String[] roleCodes) {
        ...
        List<AccountRole> accountRoles = accountRoleMapper.selectList(new QueryWrapper<AccountRole>().lambda()
                .eq(AccountRole::getUsername, username).eq(AccountRole::getTenantId, tenantId)
                .in(AccountRole::getRoleCode, roleList));
        return IAccountRoleConvert.INSTANCE.listEntity2dto(accountRoles);
    }
    ...
    private PageVO<RoleDTO> buildRoleQuery(RoleDTO roleDTO, Integer pageNo, Integer pageSize) {
        ...
        List<RoleDTO> roleList = IAuthorizationRoleConvert.INSTANCE.entityList2dto(roleIPage.getRecords());
        // 封装结果集。
