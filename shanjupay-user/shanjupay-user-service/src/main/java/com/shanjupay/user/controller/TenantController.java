...
public class TenantController {
    ...
    @ApiOperation("获取租户信息。")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "tenantId", value = "租户 id。", required = true, dataType = "Long", paramType = "path", example = "1")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "createAccountRequest", value = "创建账号请求参数。", required = true, dataType = "CreateAccountRequestDTO", paramType = "body"),
            @ApiImplicitParam(name = "tenantId", value = "租户 id。", required = true, dataType = "Long", paramType = "query", example = "1")
    })
