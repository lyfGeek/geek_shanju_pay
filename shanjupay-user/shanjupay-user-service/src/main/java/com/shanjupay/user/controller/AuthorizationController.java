...
public class AuthorizationController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "tenantIds", value = "多个租户的 id。", required = true, allowMultiple = true, dataType = "Long", paramType = "query")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "tenantId", value = "租户 id。", required = true, dataType = "Long", paramType = "path"),
    ...
    @ApiImplicitParam(name = "privilegeGroupId", value = "权限组的 id。", required = true, dataType = "Long", paramType = "path")
    ...
    @ApiOperation("查根据 roleCode 获取角色（不包含权限）。")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "tenantId", value = "租户 id。", required = true, dataType = "Long", paramType = "path"),
