...
public class MapperTest {
    ...
    @Resource
    private IAuthorizationRoleMapper authorizationRoleMapper;
    @Resource
    private IAccountRoleMapper accountRoleMapper;
    @Resource
    private IAuthorizationPrivilegeMapper authorizationPrivilegeMapper;
    @Resource
    ...
    public void testAuthorize() {
        // 入参：String username, Long[] tenantIds。
    ...
    public void test17() {
        ...
        List<AuthorizationRole> roles = IAuthorizationRoleConvert.INSTANCE.dtoList2entity(objects);
        // 租户下新增角色。
...
// // 把里面的对象转化为 JSONObject。
// JSONObject job = jsonArray.getJSONObject(i);
// // 把里面想要的参数一个个用.属性名的方式获取到。
...
// roleList.add("r_007");
        ...
        List<PrivilegeDTO> pList = IAuthorizationPrivilegeConvert.INSTANCE.entityList2dto(privileges);
...
// System.out.println("~ ~ ~ ~ ~ ~ ~ 22222 ~ ~ ~ ~ ~ ~ ~ "+pList);
        ...
        for (AuthorizationPrivilegeGroup g : groupList) {// 所有权限组。
            if (g.getParentId() == null) {// 权限组的父 id 为空，则为顶级节点。
...
//    }
    ...
    public void test09() {
        ...
        // List<MenuDTO> menuDTOS = IResourceMenuConvert.INSTANCE.entityList2dto(menus);
